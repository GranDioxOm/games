...
class Field:
  ...
  def initField(self):
    ...
    for y in range(0, self.size[1]):
      for x in range(0, self.size[0]):
        if (random.randint(1,15) == 1):
          self.field[x][y] = Bush(self.sizeTile, COLORGREEN, (x,y))
    ...
    self.field[center[0]][center[1]] = Warehouse(self.sizeTile, COLORGREEN, (center))
    self.field[center[0]][center[1]+1] = Chofli(self.sizeTile, COLORGREEN, (center[0],center[1]+1))
